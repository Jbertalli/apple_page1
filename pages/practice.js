...
export default function Sidebar () {
            ...
            <Item style={{ width: '408px', borderStyle: 'hidden', marginTop: '4em', transform: 'translate(400px)' }}>
                <div>
                                        ...
                                        <Grid.Column width={8}>
                                            <Grid.Row>
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/grayipad'), setColor(true), setGray('Space Gray')}}
                                                >
                                            ...
                                            <Grid.Row>
                                                <Button
                                                    href="#colors"
                                                    style={{ width: '197px', height: '103px', color: 'black', background: 'transparent', borderRadius: '8px', border: '.5px solid gray', fontWeight: 'normal', marginBottom: '15px' }}
                                                    onClick={() => {router.push('/colorSelection/purpleipad'), setColor(true), setPurple('Purple')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                            ...
                                            <Grid.Row>
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/starlightipad'), setColor(true), setStarlight('Starlight')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                        ...
                                        <Grid.Column width={8}>
                                            <Grid.Row>
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/pinkipad'), setColor(true), setPink('Pink')}}
                                                >   
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                                            ...
                                            <Grid.Row>
                                                <Button
                                                    ...
                                                    onClick={() => {router.push('/colorSelection/blueipad'), setColor(true), setBlue('Blue')}}
                                                >
                                                    <div className={styles.buttonHover} style={{ transform: 'translate(15px)' }}>
                        ...
                        <span style={{ display: 'flex', justifyContent: 'center', marginTop: '1.5em' }}>
                            <div className={styles.gbHover}>
                                <button
                                    ...
                                    onClick={() => {setStorage(true), setSixtyfour('64GB'), setValue(599.00)}}
                                >
                            ...
                            <button
                                ...
                                onClick={() => {setStorage(true), setOnefiftysix('156GB'), setValue(749.00)}}
                            >
                        ...
                        <span style={{ display: 'flex', justifyContent: 'center', marginTop: '1.5em' }}>
                            <div className={styles.gbHover}>
                                <button 
                                    href="#connectivities"
                                    style={{ borderRadius: '10px', border: '.5px solid gray', width: '197px', height: '106px', background: 'transparent', margin: '0em .5em 0em 0em', padding: '15px', lineHeight: '16px' }}
                                    onClick={() => {setConnectivity(true), setWifi('Wi-Fi'), setCellValue(0)}}
                                >
                            ...
                            <button
                                ...
                                style={{ borderRadius: '10px', border: '.5px solid gray', width: '197px', height: '106px', background: 'transparent', margin: '0em 0em 0em .5em', padding: '15px', lineHeight: '16px' }}
                                onClick={() => {setConnectivity(true), setCellular('Wi-Fi + Cellular'), setCellValue(150)}}
                            >
                                <h2 style={{ margin: '0em', fontSize: '17px', color: 'black' }}>
                                    Wi-Fi + Cellular
                                </h2>
                    ...
                    <div style={{ background: '#F5F5F790', borderRadius: '5px', padding: '30px', marginBottom: '450px' }}>
                        ...
                        <h3 style={{ margin: '.5em 0em 0.5em 0em' }}>
                            Add a Trade-in
                        </h3>
                        <div>
                ...
                            </div> */}
                        ...
                        <div style={{ transform: 'translate(10px, 7px)' }}>
                        ...
                        { color && storage && connectivity && engraving ? (<>
                            <div>
                                ...
                                <div>
                                    <h3 style={{ transform: 'translate(-2px, 7px)', marginBottom: '12px' }}>10.9-inch iPad Air</h3>
                                    <div style={{  fontSize: '14px', fontWeight: '400', lineHeight: '20px' }}>
                                        <div style={{ transform: 'translate(-43px, -40.5px) scale(0.16)', position: 'absolute', border: '5px solid black', width: '100px', height: '85px', borderRadius: '15px' }}>
    ...
                                            />
                                        </div>
                                        <div style={{ transform: 'translate(28px, -9px)', width: '220px' }}>Order today. Delivers to <a className={styles.bluehovering} style={{ color: 'rgb(0, 102, 204)', cursor: 'pointer' }}>91351</a><b style={{ fontWeight: '600'}}>&nbsp;Jul 13 - Jul 20 - Free</b></div>
                                    </div>
                                    <div style={{ transform: 'translate(30px, 50px)', fontSize: '14px', fontWeight: '400', lineHeight: '20px' }}>
                                        <div style={{ transform: 'translate(-57px, -209px) scale(0.55, 0.5)', position: 'absolute' }}>
    ...
                                        </div>
                                        <div style={{ transform: 'translate(-2px, -103px)', width: '200px' }}>
                                            Order now. Pick up, in store: <b style={{ fontWeight: '600' }}>Thu, Jul 21</b> at <a className={styles.bluehovering} style={{ color: 'rgb(0, 102, 204)', cursor: 'pointer' }}>Apple Valencia Town Center</a>
                                        </div>
                                    </div>
                                </div>
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    <button style={{ transform: 'translate(0px, -91px)', margin: '3em 0em -3.7em 0em', color: 'white', background: '#0066CC', border: '0px', borderRadius: '10px', width: '80vw', height: '36px', fontSize: '17px' }}>
                                        Add to Bag
                                    </button>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div>Estimated Tax   ${tax}</div>         {/* 0.08624374 = calculated tax rate according to Apple website */}
                        ...
                        <div>
                            Total ${
                                ...
                                {/* <Item style={{ marginTop: '200px', marginBottom: '100px' }}>
                                    <div>
                                        ...
                                        <div style={{ marginBottom: '30px' }}>
                                            ${
                                                (
                                                    parseFloat(value) + parseFloat(cellValue) + parseFloat(appleCare)
                                                )
                                            }.00
                                        </div>
                                        <div style={{ marginBottom: '30px' }}>
                                        ...
                                        <div style={{ marginBottom: '30px' }}>
                                            Pay Monthly with Apple Card ${
                                                                            (
                                                                                (parseFloat(value) + parseFloat(cellValue) + parseFloat(appleCare)) / 12).toFixed(2)
                                                                        }/mo. at 0% APR
                                        </div>
                                        <div style={{ marginBottom: '30px' }}>
                                            Pay in Full 
